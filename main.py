...
/* ============================================================
   3D animated protocol icons — VPN/Tunnel + LAB/TEST
   ============================================================ */
.protocol-option-icon.proto-3d{width:46px;height:46px;margin:0 0 7px;display:grid;place-items:center;position:relative;perspective:220px;z-index:2;filter:drop-shadow(0 9px 12px rgba(0,0,0,.28))}
.proto-3d .icon-core{position:relative;width:32px;height:32px;transform-style:preserve-3d;animation:protoFloat3d 3.1s ease-in-out infinite}
.proto-3d .icon-face,.proto-3d .icon-face:before,.proto-3d .icon-face:after{position:absolute;content:"";display:block;transform-style:preserve-3d}
/* TUIC: glowing 3D flame / tunnel */
.proto-tuic .icon-core{animation:protoFloat3d 2.8s ease-in-out infinite, protoSpinY 6s linear infinite}
.proto-tuic .icon-face{inset:5px 7px 2px;border-radius:58% 42% 54% 46%;background:linear-gradient(145deg,#fff7ed 0 8%,#fb923c 25%,#f97316 56%,#dc2626);box-shadow:inset -5px -6px 0 rgba(127,29,29,.22),0 0 18px rgba(249,115,22,.35);transform:rotateX(18deg) rotateZ(-10deg);clip-path:polygon(50% 0,75% 27%,68% 47%,100% 56%,68% 100%,28% 91%,0 57%,34% 49%,24% 23%)}
.proto-tuic .icon-face:before{width:11px;height:19px;left:8px;top:8px;border-radius:60% 40% 55% 45%;background:linear-gradient(180deg,#fff7ed,#fbbf24 55%,#f97316);transform:translateZ(8px) rotateZ(10deg);box-shadow:0 0 8px rgba(255,237,213,.65)}
.proto-tuic .icon-face:after{width:38px;height:8px;left:-3px;bottom:-4px;border-radius:50%;background:rgba(249,115,22,.28);filter:blur(5px);transform:translateZ(-6px)}
/* WireGuard: 3D shield with rotating wire ring */
.proto-wireguard .icon-core{animation:protoFloat3d 3.3s ease-in-out infinite, protoTilt3d 5.5s ease-in-out infinite}
.proto-wireguard .icon-face{inset:2px 4px 1px;border-radius:9px 9px 15px 15px;background:linear-gradient(145deg,#e0f2fe,#60a5fa 38%,#2563eb 72%,#172554);clip-path:polygon(50% 0,94% 15%,87% 62%,68% 88%,50% 100%,32% 88%,13% 62%,6% 15%);box-shadow:inset 5px 5px 5px rgba(255,255,255,.28),inset -7px -8px 8px rgba(15,23,42,.38),0 9px 16px rgba(37,99,235,.3);transform:translateZ(2px)}
.proto-wireguard .icon-face:before{width:16px;height:16px;left:8px;top:8px;border:3px solid rgba(255,255,255,.9);border-radius:50%;border-top-color:transparent;transform:translateZ(9px) rotateY(35deg);box-shadow:0 0 9px rgba(255,255,255,.32)}
.proto-wireguard .icon-face:after{inset:-7px -5px;border:2px solid rgba(56,189,248,.45);border-radius:50%;transform:translateZ(-7px) rotateX(68deg);animation:protoRing 2.6s linear infinite}
/* Turbo LAB: 3D lightning bolt */
.proto-highspeed .icon-core{animation:protoFloat3d 2.5s ease-in-out infinite, protoSpinY 5.5s linear infinite}
.proto-highspeed .icon-face{inset:2px 7px 1px;background:linear-gradient(145deg,#fef3c7,#facc15 34%,#f59e0b 68%,#b45309);clip-path:polygon(56% 0,96% 0,63% 39%,88% 39%,31% 100%,41% 55%,12% 55%);filter:drop-shadow(0 4px 5px rgba(245,158,11,.42));transform:translateZ(3px) rotateZ(-7deg)}
.proto-highspeed .icon-face:before{inset:4px -2px;background:linear-gradient(90deg,transparent,rgba(255,255,255,.8),transparent);transform:translateZ(8px) skewX(-18deg);animation:protoShine 1.8s ease-in-out infinite}
.proto-highspeed .icon-face:after{width:42px;height:9px;left:-5px;bottom:-5px;border-radius:50%;background:rgba(245,158,11,.3);filter:blur(6px);transform:translateZ(-7px)}
/* Gaming LAB: 3D gamepad */
.proto-gaming .icon-core{animation:protoFloat3d 3s ease-in-out infinite, protoTilt3d 4.6s ease-in-out infinite}
.proto-gaming .icon-face{left:2px;top:7px;width:28px;height:20px;border-radius:9px 9px 11px 11px;background:linear-gradient(145deg,#f8fafc,#94a3b8 38%,#475569 70%,#1e293b);box-shadow:inset 2px 2px 4px rgba(255,255,255,.5),inset -4px -5px 5px rgba(15,23,42,.5),0 8px 13px rgba(15,23,42,.35);transform:translateZ(4px) rotateX(16deg)}
.proto-gaming .icon-face:before{width:8px;height:8px;left:6px;top:6px;border-left:3px solid #0f172a;border-top:3px solid #0f172a;transform:translateZ(6px);box-shadow:7px 0 0 -1px #0f172a,14px 0 0 -2px #38bdf8,14px 5px 0 -2px #a78bfa}
.proto-gaming .icon-face:after{width:38px;height:8px;left:-5px;bottom:-7px;border:2px solid rgba(96,165,250,.35);border-radius:50%;transform:translateZ(-6px) rotateX(65deg);animation:protoRing 2.9s linear infinite reverse}
@keyframes protoFloat3d{0%,100%{transform:translateY(0) rotateX(8deg) rotateY(-8deg)}50%{transform:translateY(-5px) rotateX(-5deg) rotateY(10deg)}}
@keyframes protoSpinY{from{transform:translateY(0) rotateY(-12deg)}50%{transform:translateY(-4px) rotateY(12deg)}to{transform:translateY(0) rotateY(-12deg)}}
@keyframes protoTilt3d{0%,100%{transform:translateY(0) rotateX(8deg) rotateY(-10deg) rotateZ(-2deg)}50%{transform:translateY(-4px) rotateX(-4deg) rotateY(10deg) rotateZ(2deg)}}
@keyframes protoRing{to{transform:translateZ(-6px) rotateX(65deg) rotateZ(360deg)}}
@keyframes protoShine{0%,35%{opacity:0;transform:translateZ(8px) translateX(-16px) skewX(-18deg)}55%,75%{opacity:.9}100%{opacity:0;transform:translateZ(8px) translateX(16px) skewX(-18deg)}}
.protocol-option:hover .proto-3d .icon-core{animation-duration:1.35s}
.protocol-option.selected .proto-3d{filter:drop-shadow(0 10px 17px rgba(56,189,248,.3))}
...
const PROTOCOL_PICKER_GROUPS=[
  ...
  {title:'LAB / TEST',ids:['highspeed-demo','gaming-lite-demo']}
];
...
function protocolIconMarkup(id){
  const cls={
    'tuic':'proto-tuic','wireguard':'proto-wireguard',
    'highspeed-demo':'proto-highspeed','gaming-lite-demo':'proto-gaming'
  }[id];
  if(!cls) return `<span class="protocol-option-icon">${PROTOCOL_PICKER_ICONS[id]||'◉'}</span>`;
  return `<span class="protocol-option-icon proto-3d ${cls}" aria-hidden="true"><span class="icon-core"><span class="icon-face"></span></span></span>`;
}
