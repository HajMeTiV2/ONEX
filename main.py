...
/* ============================================================
   STYLE 1 — NEON MODERN / REAL CSS 3D ANIMATED ICONS
   No emoji icons. Each protocol has a unique silhouette/material.
   ============================================================ */
.protocol-option-icon.proto-3d{width:62px;height:62px;display:grid;place-items:center;position:relative;perspective:520px;flex:0 0 auto;z-index:2;filter:drop-shadow(0 10px 16px rgba(0,0,0,.38))}
.proto-3d .icon-core{width:43px;height:43px;position:relative;transform-style:preserve-3d;animation:protoFloat 3.2s ease-in-out infinite}
.proto-3d .icon-face,.proto-3d .icon-back{position:absolute;inset:4px;display:grid;place-items:center;transform-style:preserve-3d}
.proto-3d .icon-face{background:linear-gradient(145deg,var(--p1),var(--p2) 52%,var(--p3));box-shadow:inset 4px 4px 7px rgba(255,255,255,.42),inset -9px -10px 12px rgba(0,0,0,.35),0 8px 18px var(--glow),0 0 20px var(--glow);transform:translateZ(9px) rotateX(12deg) rotateY(-15deg);overflow:visible}
.proto-3d .icon-back{background:linear-gradient(145deg,var(--p2),var(--p3));filter:brightness(.72);transform:translateZ(-6px) rotateX(12deg) rotateY(-15deg) translate(3px,5px);box-shadow:0 8px 14px rgba(0,0,0,.35)}
.proto-3d .icon-glyph{font:900 11px/1 Arial,sans-serif;color:#fff;letter-spacing:-.5px;text-shadow:0 2px 2px rgba(0,0,0,.55),0 0 9px #fff;transform:translateZ(15px);user-select:none}
.proto-3d .icon-orbit{position:absolute;inset:-7px;border:1.7px solid rgba(255,255,255,.48);border-left-color:transparent;border-radius:50%;transform:translateZ(3px) rotateX(66deg) rotateZ(20deg);animation:protoSpin 2.3s linear infinite}
.proto-3d .icon-aura{position:absolute;width:30px;height:12px;border-radius:50%;background:var(--glow);filter:blur(8px);bottom:4px;opacity:.9;animation:protoAura 2.1s ease-in-out infinite}
.proto-3d .icon-spark{position:absolute;width:6px;height:6px;border-radius:2px;background:#fff;box-shadow:0 0 8px #fff,0 0 16px var(--glow);transform:translateZ(18px) rotate(45deg);animation:protoSpark 1.45s ease-in-out infinite}
.proto-3d .icon-spark.s1{right:-3px;top:0}.proto-3d .icon-spark.s2{left:0;bottom:1px;width:4px;height:4px;animation-delay:.55s}
.proto-vless-ws{--p1:#67e8f9;--p2:#2563eb;--p3:#312e81;--glow:rgba(34,211,238,.72)}
.proto-xhttp-packet-up{--p1:#86efac;--p2:#059669;--p3:#064e3b;--glow:rgba(16,185,129,.72)}
.proto-xhttp-stream-up{--p1:#fde68a;--p2:#f59e0b;--p3:#92400e;--glow:rgba(245,158,11,.72)}
.proto-xhttp-stream-one{--p1:#ddd6fe;--p2:#7c3aed;--p3:#3b0764;--glow:rgba(139,92,246,.74)}
.proto-vmess-ws{--p1:#bfdbfe;--p2:#4f46e5;--p3:#1e1b4b;--glow:rgba(99,102,241,.76)}
.proto-trojan-ws{--p1:#fecdd3;--p2:#e11d48;--p3:#4c0519;--glow:rgba(244,63,94,.76)}
.proto-shadowsocks{--p1:#d9f99d;--p2:#65a30d;--p3:#365314;--glow:rgba(132,204,22,.72)}
.proto-socks5{--p1:#7dd3fc;--p2:#0284c7;--p3:#082f49;--glow:rgba(14,165,233,.74)}
.proto-http{--p1:#f8fafc;--p2:#64748b;--p3:#1e293b;--glow:rgba(148,163,184,.68)}
.proto-hysteria2{--p1:#a5f3fc;--p2:#0891b2;--p3:#164e63;--glow:rgba(6,182,212,.76)}
.proto-tuic{--p1:#fed7aa;--p2:#f97316;--p3:#7c2d12;--glow:rgba(249,115,22,.80)}
.proto-wireguard{--p1:#dbeafe;--p2:#2563eb;--p3:#172554;--glow:rgba(37,99,235,.78)}
.proto-highspeed-demo{--p1:#fef08a;--p2:#eab308;--p3:#713f12;--glow:rgba(234,179,8,.80)}
.proto-gaming-lite-demo{--p1:#f5d0fe;--p2:#a855f7;--p3:#581c87;--glow:rgba(168,85,247,.82)}
.kind-rocket .icon-face{clip-path:polygon(50% 0,72% 17%,91% 48%,76% 78%,50% 100%,24% 78%,9% 48%,28% 17%);border-radius:20px}
.kind-packet .icon-face{clip-path:polygon(12% 22%,82% 10%,94% 50%,82% 90%,12% 78%);border-radius:8px}.kind-packet .icon-orbit{transform:translateZ(3px) rotateX(12deg) rotateY(67deg)}
.kind-pulse .icon-face{clip-path:polygon(5% 48%,29% 48%,39% 18%,47% 79%,56% 31%,66% 61%,95% 61%,95% 78%,59% 78%,50% 100%,42% 55%,34% 92%,26% 66%,5% 66%);border-radius:8px}
.kind-core .icon-face{clip-path:polygon(50% 0,94% 25%,94% 75%,50% 100%,6% 75%,6% 25%);border-radius:9px}.kind-core .icon-orbit{transform:translateZ(3px) rotateX(56deg) rotateY(55deg)}
.kind-mesh .icon-face{border-radius:50%;clip-path:polygon(50% 0,61% 28%,88% 12%,72% 50%,88% 88%,50% 72%,12% 88%,28% 50%,12% 12%,39% 28%)}
.kind-trojan .icon-face{clip-path:polygon(50% 0,84% 18%,96% 58%,73% 100%,27% 100%,4% 58%,16% 18%);border-radius:13px}
.kind-shadow .icon-face{border-radius:50%;clip-path:polygon(50% 0,61% 38%,100% 50%,61% 62%,50% 100%,39% 62%,0 50%,39% 38%)}
.kind-socket .icon-face{border-radius:50% 50% 12px 12px;clip-path:polygon(18% 5%,82% 5%,94% 30%,82% 88%,50% 100%,18% 88%,6% 30%)}
.kind-shield .icon-face{clip-path:polygon(50% 0,90% 18%,84% 69%,50% 100%,16% 69%,10% 18%);border-radius:11px}
.kind-vortex .icon-face{border-radius:50%;clip-path:polygon(50% 0,64% 22%,92% 18%,74% 50%,92% 82%,64% 78%,50% 100%,36% 78%,8% 82%,26% 50%,8% 18%,36% 22%)}.kind-vortex .icon-orbit{animation-duration:1.5s}
.kind-blaze .icon-face{clip-path:polygon(50% 0,76% 27%,91% 20%,81% 53%,100% 58%,66% 100%,56% 67%,31% 88%,39% 55%,12% 57%,31% 28%);border-radius:13px}
.kind-orbit .icon-face{border-radius:50%}.kind-orbit .icon-orbit{inset:-8px;border-width:2px;transform:translateZ(3px) rotateX(66deg) rotateZ(25deg)}
.kind-turbo .icon-face{clip-path:polygon(0 50%,27% 31%,23% 7%,55% 25%,83% 0,75% 37%,100% 50%,73% 63%,77% 93%,45% 75%,17% 100%,25% 63%);border-radius:9px}
.kind-game .icon-face{clip-path:polygon(17% 27%,34% 18%,50% 26%,66% 18%,83% 27%,93% 72%,72% 88%,50% 70%,28% 88%,7% 72%);border-radius:14px}
@keyframes protoFloat{0%,100%{transform:translateY(0) rotateX(5deg) rotateY(-10deg)}50%{transform:translateY(-5px) rotateX(-7deg) rotateY(10deg)}}
@keyframes protoSpin{to{rotate:360deg}}
@keyframes protoSpark{0%,100%{opacity:.35;scale:.7}50%{opacity:1;scale:1.35}}
@keyframes protoAura{0%,100%{transform:scaleX(.75);opacity:.55}50%{transform:scaleX(1.15);opacity:1}}
.protocol-option:hover .icon-core{animation-duration:1.35s}.protocol-option.selected .proto-3d{filter:drop-shadow(0 12px 25px var(--glow))}.protocol-option.selected .icon-orbit{animation-duration:1.15s}.protocol-option.selected .icon-face{box-shadow:inset 4px 4px 7px rgba(255,255,255,.48),inset -9px -10px 12px rgba(0,0,0,.32),0 10px 24px var(--glow),0 0 30px var(--glow)}
...
function protocolIconMarkup(id){
  const glyph=PROTOCOL_PICKER_ICONS[id]||'◆';
  const kind=PROTOCOL_PICKER_KINDS[id]||'core';
  return `<span class="protocol-option-icon proto-3d proto-${id} kind-${kind}" aria-hidden="true"><span class="icon-aura"></span><span class="icon-core"><span class="icon-back"></span><span class="icon-face"><span class="icon-glyph">${glyph}</span></span><span class="icon-orbit"></span><span class="icon-spark s1"></span><span class="icon-spark s2"></span></span></span>`;
}
function setupProtocolPickers(){
  ['cProto','aProto'].forEach(id=>{
    const sel=document.getElementById(id); if(!sel)return;
    sel.classList.add('protocol-native'); sel.setAttribute('aria-hidden','true'); sel.tabIndex=-1;
    sel.style.setProperty('display','none','important');
    let trigger=sel.parentNode.querySelector(`.protocol-trigger[data-for="${id}"]`);
    if(!trigger){
    ...
    trigger.onclick=e=>{e.preventDefault();openProtocolPicker(id)};
...
function ensureProtocolPicker(){
  ...
  bg.innerHTML=`<div class="protocol-picker" role="dialog" aria-modal="true">
    <div class="protocol-picker-head"><div class="protocol-picker-head-icon"><span>✦</span></div><div class="protocol-picker-head-text"><div class="protocol-picker-title">${lang==='fa'?'انتخاب پروتکل':'Select Protocol'}</div><div class="protocol-picker-subtitle">${lang==='fa'?'پروتکل موردنظر را انتخاب کنید':'Choose the protocol you want to use'}</div></div><button type="button" class="protocol-picker-close" id="protocolPickerClose">×</button></div>
    <div class="protocol-picker-scroll" id="protocolPickerScroll"></div>
    <div class="protocol-picker-foot"><div class="protocol-selected-info" id="protocolSelectedInfo">—</div><button type="button" class="protocol-picker-confirm" id="protocolPickerConfirm">${lang==='fa'?'تأیید و ادامه →':'Confirm & Continue →'}</button></div>
  </div>`;
  document.body.appendChild(bg);
  bg.addEventListener('click',e=>{if(e.target===bg)closeProtocolPicker()});
  bg.querySelector('#protocolPickerClose').onclick=closeProtocolPicker;
  bg.querySelector('#protocolPickerConfirm').onclick=confirmProtocolPicker;
  return bg;
}
function openProtocolPicker(targetId){
  const sel=document.getElementById(targetId); if(!sel)return;
  const bg=ensureProtocolPicker(); __protocolPickerTarget=targetId;
  const current=sel.value||'vless-ws', available=new Set([...sel.options].map(o=>o.value));
  const scroll=bg.querySelector('#protocolPickerScroll');
  scroll.innerHTML=PROTOCOL_PICKER_GROUPS.map(g=>{
    const ids=g.ids.filter(id=>available.has(id)); if(!ids.length)return '';
    return `<section class="protocol-section"><div class="protocol-section-title"><span>${g.title}</span><i>⌁</i></div><div class="protocol-grid">${ids.map(id=>{
      const p=__protocolPickerOptions.find(x=>x.id===id)||{id,label:id};
      const name=protocolPickerShort(id,p.label);
      return `<button type="button" class="protocol-option ${id===current?'selected':''}" data-proto="${esc(id)}"><span class="protocol-option-radio"></span>${protocolIconMarkup(id)}<span class="protocol-option-name">${esc(name)}</span><span class="protocol-option-desc">${id===current?(lang==='fa'?'انتخاب‌شده':'Selected'):(lang==='fa'?'برای انتخاب کلیک کنید':'Tap to choose')}</span></button>`;
    }).join('')}</div></section>`;
  }).join('');
  scroll.querySelectorAll('.protocol-option').forEach(btn=>btn.addEventListener('click',()=>chooseProtocol(btn.dataset.proto)));
  bg.querySelector('#protocolSelectedInfo').textContent=(lang==='fa'?'پروتکل انتخاب‌شده: ':'Selected: ')+protocolPickerShort(current,protocolPickerLabel(current));
  bg.classList.add('open'); document.body.style.overflow='hidden';
}
function chooseProtocol(id){
  const sel=document.getElementById(__protocolPickerTarget), bg=document.getElementById('protocolPickerBg'); if(!sel||!bg)return;
  sel.value=id;
  bg.querySelectorAll('.protocol-option').forEach(x=>x.classList.toggle('selected',x.dataset.proto===id));
  bg.querySelector('#protocolSelectedInfo').textContent=(lang==='fa'?'پروتکل انتخاب‌شده: ':'Selected: ')+protocolPickerShort(id,protocolPickerLabel(id));
  syncProtocolPicker(__protocolPickerTarget);
}
function confirmProtocolPicker(){
  if(__protocolPickerTarget){const sel=document.getElementById(__protocolPickerTarget);if(sel)sel.dispatchEvent(new Event('change',{bubbles:true}));}
  closeProtocolPicker();
}
