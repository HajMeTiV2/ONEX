...
<style>
.tg-links-card{overflow:hidden}.tg-links-head{display:flex;align-items:center;gap:18px;margin-bottom:20px}.tg-links-title{font-size:22px;font-weight:900;color:var(--t1)}.tg-links-sub{font-size:12px;color:var(--t3);margin-top:5px}.tg-3d-hero{width:78px;height:78px;perspective:500px;flex:0 0 auto}.tg-cube{position:relative;width:58px;height:58px;margin:10px;transform:rotateX(-12deg) rotateY(25deg);transform-style:preserve-3d;filter:drop-shadow(0 12px 18px rgba(31,126,255,.38))}.tg-cube:before,.tg-cube:after,.cube-front{content:"";position:absolute;inset:0;border-radius:12px}.tg-cube:before{background:linear-gradient(145deg,#45e0ff,#2474ff 55%,#5d31ff);transform:translateZ(10px)}.cube-side{position:absolute;right:-10px;top:7px;width:10px;height:49px;background:linear-gradient(#1c6de9,#3515a7);transform:skewY(-38deg);transform-origin:left}.cube-top{position:absolute;left:7px;top:-10px;width:50px;height:12px;background:linear-gradient(90deg,#70f3ff,#448cff,#8b55ff);transform:skewX(-48deg);border-radius:8px}.cube-front{display:flex;align-items:center;justify-content:center;z-index:2}.cube-front svg{width:32px;height:32px;color:#fff;filter:drop-shadow(0 2px 3px rgba(0,0,0,.35))}.tg-link-list{display:grid;gap:12px}.tg-link-row{display:flex;align-items:center;gap:15px;text-decoration:none!important;padding:14px 16px;border:1px solid rgba(48,145,255,.28);border-radius:18px;background:linear-gradient(120deg,rgba(9,34,68,.82),rgba(7,20,43,.7));box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 8px 24px rgba(0,0,0,.16);transition:.2s ease}.tg-link-row:hover{transform:translateY(-2px);border-color:rgba(63,174,255,.75);box-shadow:0 0 24px rgba(25,137,255,.18),inset 0 1px 0 rgba(255,255,255,.09)}.tg-link-copy{display:flex;flex-direction:column;gap:5px;min-width:0;flex:1}.tg-link-copy b{color:var(--t1);font-size:14px}.tg-link-copy span{color:var(--accent2);font-size:13px;direction:ltr;text-align:right;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tg-link-arrow{font-size:22px;color:#6db9ff}.tg-real3d{width:58px;height:58px;display:block;position:relative;perspective:450px;flex:0 0 58px}.tg3d-face,.tg3d-back{position:absolute;width:45px;height:45px;top:7px;left:7px;border-radius:11px;display:flex;align-items:center;justify-content:center;transform:rotateX(-8deg) rotateY(12deg);transform-style:preserve-3d}.tg3d-face{z-index:2;background:linear-gradient(145deg,#55e9ff 0%,#168cff 48%,#5a2cff 100%);box-shadow:inset 2px 2px 7px rgba(255,255,255,.35),inset -4px -6px 10px rgba(0,0,0,.2),0 8px 18px rgba(25,123,255,.35)}.tg3d-back{background:linear-gradient(145deg,#0c4387,#15205e);transform:translate(7px,5px) rotateX(-8deg) rotateY(12deg);box-shadow:0 10px 15px rgba(0,0,0,.25)}.tg-real3d svg{width:27px;height:27px;color:#fff;filter:drop-shadow(0 2px 3px rgba(0,0,0,.35))}.tg-real3d-github .tg3d-face{background:linear-gradient(145deg,#dfe8f7,#687b96 48%,#182235)}.tg-real3d-github .tg3d-back{background:linear-gradient(145deg,#3d4b60,#101827)}
@media(max-width:600px){.tg-links-head{gap:12px}.tg-links-title{font-size:19px}.tg-3d-hero{width:64px;height:64px}.tg-link-row{padding:12px}.tg-real3d{width:52px;height:52px;flex-basis:52px}.tg3d-face,.tg3d-back{width:41px;height:41px}.tg-real3d svg{width:24px;height:24px}}
</style>
<script>
...
<section class="page" id="page-news">
  ...
  <div class="card tg-links-card" id="newsCard">
    <div class="tg-links-head">
      <div class="tg-3d-hero" aria-hidden="true"><div class="tg-cube"><span class="cube-top"></span><span class="cube-side"></span><span class="cube-front"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.7 3.3 18.2 20c-.27 1.2-.98 1.5-1.98.93l-5.22-3.85-2.5 2.4c-.28.28-.51.51-1.05.51l.37-5.3 9.67-8.74c.42-.38-.09-.59-.65-.21L5 12.85.2 11.32c-1.05-.33-1.06-1.05.22-1.55L19.02 2.55c.9-.33 1.67.2 1.58.75Z"/></svg></span></div></div>
      <div><div class="tg-links-title" id="newsTitle">تلگرام</div><div class="tg-links-sub">آخرین اخبار و اطلاع‌رسانی‌های پروژه</div></div>
    </div>
    <div id="newsBody" class="tg-link-list">
      <a class="tg-link-row" href="https://t.me/V2rayTun0" target="_blank" rel="noopener noreferrer">
        <span class="tg-real3d tg-real3d-telegram" aria-hidden="true"><span class="tg3d-back"></span><span class="tg3d-face"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.7 3.3 18.2 20c-.27 1.2-.98 1.5-1.98.93l-5.22-3.85-2.5 2.4c-.28.28-.51.51-1.05.51l.37-5.3 9.67-8.74c.42-.38-.09-.59-.65-.21L5 12.85.2 11.32c-1.05-.33-1.06-1.05.22-1.55L19.02 2.55c.9-.33 1.67.2 1.58.75Z"/></svg></span></span>
        <span class="tg-link-copy"><b>کانال تلگرام</b><span>@V2rayTun0</span></span><span class="tg-link-arrow">↗</span>
      </a>
      <a class="tg-link-row" href="https://t.me/Mehtif" target="_blank" rel="noopener noreferrer">
        <span class="tg-real3d tg-real3d-telegram" aria-hidden="true"><span class="tg3d-back"></span><span class="tg3d-face"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.7 3.3 18.2 20c-.27 1.2-.98 1.5-1.98.93l-5.22-3.85-2.5 2.4c-.28.28-.51.51-1.05.51l.37-5.3 9.67-8.74c.42-.38-.09-.59-.65-.21L5 12.85.2 11.32c-1.05-.33-1.06-1.05.22-1.55L19.02 2.55c.9-.33 1.67.2 1.58.75Z"/></svg></span></span>
        <span class="tg-link-copy"><b>سازنده</b><span>@Mehtif</span></span><span class="tg-link-arrow">↗</span>
      </a>
      <a class="tg-link-row" href="https://github.com/HajMeTiV2/ONEX" target="_blank" rel="noopener noreferrer">
        <span class="tg-real3d tg-real3d-github" aria-hidden="true"><span class="tg3d-back"></span><span class="tg3d-face"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 .7a11.3 11.3 0 0 0-3.57 22.02c.56.1.77-.24.77-.54v-2.1c-3.14.68-3.8-1.33-3.8-1.33-.5-1.27-1.22-1.61-1.22-1.61-1-.69.08-.67.08-.67 1.1.08 1.68 1.13 1.68 1.13.98 1.68 2.58 1.2 3.2.92.1-.71.39-1.2.7-1.48-2.51-.29-5.15-1.26-5.15-5.6 0-1.24.44-2.25 1.13-3.05-.11-.28-.49-1.44.11-3 0 0 .92-.3 3.02 1.16A10.5 10.5 0 0 1 12 6.2c.93 0 1.86.13 2.73.37 2.1-1.46 3.02-1.16 3.02-1.16.6 1.56.22 2.72.11 3 .7.8 1.13 1.81 1.13 3.05 0 4.35-2.65 5.3-5.17 5.59.4.34.75 1.02.75 2.06v3.05c0 .3.2.65.78.54A11.3 11.3 0 0 0 12 .7Z"/></svg></span></span>
        <span class="tg-link-copy"><b>گیت‌هاب پروژه</b><span>github.com/HajMeTiV2/ONEX</span></span><span class="tg-link-arrow">↗</span>
      </a>
    </div>
...
async function panelUpdate(){
  ...
  b.innerHTML=(lang==='fa'
    ?'<p style="margin-bottom:12px">اپدیت با خطا مواجه شد. اپدیت را دستی انجام دهید.</p><a href="https://github.com/HajMeTiV2/ONEX" target="_blank" rel="noopener" style="color:var(--accent2);font-weight:700">github.com/HajMeTiV2/ONEX</a>'
    :'<p style="margin-bottom:12px">Update failed. Please update manually.</p><a href="https://github.com/HajMeTiV2/ONEX" target="_blank" rel="noopener" style="color:var(--accent2);font-weight:700">github.com/HajMeTiV2/ONEX</a>');
}
...
async function loadNews(toastOk){
  ...
  if(meta) meta.textContent=(lang==='fa'?'آخرین بروزرسانی: ':'Last update: ')+(r&&r.updated_at||'—');
