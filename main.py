...
/* ============================================================
   STYLE 1 — NEON MODERN / CHUNKY 3D PROTOCOL ICONS
   Every protocol gets its own silhouette, glow and motion language.
   ============================================================ */
.protocol-option-icon.proto-3d{width:54px;height:54px;margin:0 0 5px;display:grid;place-items:center;position:relative;perspective:420px;z-index:2;filter:drop-shadow(0 9px 14px rgba(0,0,0,.34))}
.proto-3d .icon-core{position:relative;width:42px;height:42px;transform-style:preserve-3d;animation:protoFloat3d 3.2s ease-in-out infinite,protoTurn3d 6.8s ease-in-out infinite}
.proto-3d .icon-face{position:absolute;inset:4px;border-radius:13px;background:linear-gradient(145deg,var(--p1),var(--p2) 48%,var(--p3));box-shadow:inset 5px 5px 6px rgba(255,255,255,.34),inset -8px -9px 10px rgba(0,0,0,.34),0 10px 18px var(--glow),0 0 18px var(--glow);transform:translateZ(7px) rotateX(15deg) rotateY(-12deg);display:grid;place-items:center;transform-style:preserve-3d;overflow:visible}
.proto-3d .icon-face:before{content:"";position:absolute;inset:-5px;border-radius:inherit;border:2px solid rgba(255,255,255,.28);box-shadow:0 0 10px var(--glow);transform:translateZ(-7px) rotateX(66deg);animation:protoRing 2.4s linear infinite}
.proto-3d .icon-face:after{content:"";position:absolute;width:34px;height:9px;left:4px;bottom:-10px;border-radius:50%;background:var(--glow);filter:blur(6px);transform:translateZ(-10px);opacity:.85}
.proto-3d .icon-glyph{font:900 9px/1 Arial,sans-serif;letter-spacing:-.5px;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.6),0 0 7px rgba(255,255,255,.28);transform:translateZ(13px) rotateX(-5deg);user-select:none}
.proto-3d .icon-orbit{position:absolute;inset:-1px;border:1.5px solid rgba(255,255,255,.34);border-left-color:transparent;border-radius:50%;transform:translateZ(2px) rotateX(68deg) rotateZ(18deg);animation:protoOrbit 2.2s linear infinite}
.proto-3d .icon-spark{position:absolute;width:7px;height:7px;right:-1px;top:1px;background:#fff;border-radius:2px;box-shadow:0 0 8px #fff,0 0 15px var(--glow);transform:translateZ(16px) rotate(45deg);animation:protoSpark 1.7s ease-in-out infinite}
/* Individual neon materials */
.proto-vless-ws{--p1:#7dd3fc;--p2:#2563eb;--p3:#312e81;--glow:rgba(34,211,238,.68)}
.proto-xhttp-packet-up{--p1:#6ee7b7;--p2:#059669;--p3:#064e3b;--glow:rgba(16,185,129,.68)}
.proto-xhttp-stream-up{--p1:#fde68a;--p2:#f59e0b;--p3:#92400e;--glow:rgba(245,158,11,.70)}
.proto-xhttp-stream-one{--p1:#c4b5fd;--p2:#7c3aed;--p3:#3b0764;--glow:rgba(139,92,246,.70)}
.proto-vmess-ws{--p1:#93c5fd;--p2:#4f46e5;--p3:#1e1b4b;--glow:rgba(99,102,241,.72)}
.proto-trojan-ws{--p1:#fda4af;--p2:#e11d48;--p3:#4c0519;--glow:rgba(244,63,94,.70)}
.proto-shadowsocks{--p1:#bef264;--p2:#65a30d;--p3:#365314;--glow:rgba(132,204,22,.68)}
.proto-socks5{--p1:#7dd3fc;--p2:#0284c7;--p3:#082f49;--glow:rgba(14,165,233,.70)}
.proto-http{--p1:#f1f5f9;--p2:#64748b;--p3:#1e293b;--glow:rgba(148,163,184,.62)}
.proto-hysteria2{--p1:#67e8f9;--p2:#0891b2;--p3:#164e63;--glow:rgba(6,182,212,.72)}
.proto-tuic{--p1:#fed7aa;--p2:#f97316;--p3:#7c2d12;--glow:rgba(249,115,22,.76)}
.proto-wireguard{--p1:#bfdbfe;--p2:#2563eb;--p3:#172554;--glow:rgba(37,99,235,.74)}
.proto-highspeed-demo{--p1:#fef08a;--p2:#eab308;--p3:#713f12;--glow:rgba(234,179,8,.76)}
.proto-gaming-lite-demo{--p1:#f5d0fe;--p2:#a855f7;--p3:#581c87;--glow:rgba(168,85,247,.78)}
/* Unique silhouettes for the 14 protocols */
.kind-rocket .icon-face{clip-path:polygon(50% 0,72% 17%,91% 48%,75% 78%,50% 100%,25% 78%,9% 48%,28% 17%);border-radius:20px}
.kind-rocket .icon-orbit{transform:translateZ(2px) rotateX(72deg) rotateZ(-28deg)}
.kind-packet .icon-face{border-radius:7px;transform:translateZ(7px) rotateX(15deg) rotateY(-12deg) skewY(-3deg)}
.kind-packet .icon-spark{width:13px;height:4px;border-radius:99px;right:-4px;top:8px;transform:translateZ(18px) rotate(-18deg)}
.kind-pulse .icon-face{border-radius:50% 50% 42% 42%;clip-path:polygon(8% 22%,34% 22%,43% 0,52% 100%,61% 52%,92% 52%,92% 78%,55% 78%,48% 100%,39% 36%,31% 47%,8% 47%)}
.kind-pulse .icon-orbit{border-radius:12px;transform:translateZ(2px) rotateX(10deg) rotateY(62deg)}
.kind-core .icon-face{clip-path:polygon(50% 0,94% 25%,94% 75%,50% 100%,6% 75%,6% 25%);border-radius:8px}
.kind-core .icon-orbit{transform:translateZ(2px) rotateX(55deg) rotateY(55deg)}
.kind-mesh .icon-face{border-radius:50%;clip-path:polygon(50% 0,61% 28%,88% 12%,72% 50%,88% 88%,50% 72%,12% 88%,28% 50%,12% 12%,39% 28%)}
.kind-mesh .icon-orbit{inset:-4px;transform:translateZ(2px) rotateX(70deg) rotateZ(55deg)}
.kind-trojan .icon-face{clip-path:polygon(50% 0,84% 18%,96% 58%,73% 100%,27% 100%,4% 58%,16% 18%);border-radius:14px}
.kind-trojan .icon-spark{width:9px;height:9px;border-radius:50%;right:0;top:0}
.kind-shadow .icon-face{border-radius:50%;clip-path:polygon(50% 0,61% 38%,100% 50%,61% 62%,50% 100%,39% 62%,0 50%,39% 38%)}
.kind-shadow .icon-orbit{inset:-4px;transform:translateZ(2px) rotateX(62deg) rotateZ(-18deg)}
.kind-socket .icon-face{border-radius:50% 50% 13px 13px;clip-path:polygon(18% 5%,82% 5%,94% 30%,82% 88%,50% 100%,18% 88%,6% 30%)}
.kind-socket .icon-orbit{transform:translateZ(2px) rotateX(76deg)}
.kind-shield .icon-face{clip-path:polygon(50% 0,90% 18%,84% 69%,50% 100%,16% 69%,10% 18%);border-radius:12px}
.kind-shield .icon-orbit{transform:translateZ(2px) rotateX(62deg) rotateZ(45deg)}
.kind-vortex .icon-face{border-radius:50%;clip-path:polygon(50% 0,64% 22%,92% 18%,74% 50%,92% 82%,64% 78%,50% 100%,36% 78%,8% 82%,26% 50%,8% 18%,36% 22%)}
.kind-vortex .icon-orbit{inset:-6px;transform:translateZ(2px) rotateX(67deg) rotateZ(20deg);animation-duration:1.5s}
.kind-blaze .icon-face{clip-path:polygon(50% 0,76% 27%,91% 20%,81% 53%,100% 58%,66% 100%,56% 67%,31% 88%,39% 55%,12% 57%,31% 28%);border-radius:15px}
.kind-blaze .icon-spark{width:5px;height:18px;border-radius:99px;right:2px;top:-3px;transform:translateZ(19px) rotate(24deg)}
.kind-orbit .icon-face{border-radius:50%;transform:translateZ(7px) rotateX(18deg) rotateY(-18deg)}
.kind-orbit .icon-orbit{inset:-7px;border-width:2px;transform:translateZ(2px) rotateX(66deg) rotateZ(25deg)}
.kind-turbo .icon-face{clip-path:polygon(0 50%,27% 31%,23% 7%,55% 25%,83% 0,75% 37%,100% 50%,73% 63%,77% 93%,45% 75%,17% 100%,25% 63%);border-radius:10px}
.kind-turbo .icon-orbit{transform:translateZ(2px) rotateX(24deg) rotateY(64deg)}
.kind-game .icon-face{clip-path:polygon(17% 27%,34% 18%,50% 26%,66% 18%,83% 27%,93% 72%,72% 88%,50% 70%,28% 88%,7% 72%);border-radius:16px}
.kind-game .icon-orbit{transform:translateZ(2px) rotateX(58deg) rotateZ(-42deg)}
@keyframes protoFloat3d{0%,100%{transform:translateY(0) rotateX(8deg) rotateY(-14deg)}50%{transform:translateY(-5px) rotateX(-7deg) rotateY(14deg)}}
@keyframes protoTurn3d{0%{rotate:0deg}50%{rotate:180deg}100%{rotate:360deg}}
@keyframes protoRing{to{transform:translateZ(-7px) rotateX(66deg) rotateZ(360deg)}}
@keyframes protoOrbit{to{rotate:360deg}}
@keyframes protoSpark{0%,100%{opacity:.45;scale:.75}50%{opacity:1;scale:1.25}}
.protocol-option:hover .proto-3d .icon-core{animation-duration:1.25s,1.2s}
.protocol-option.selected .proto-3d{filter:drop-shadow(0 12px 22px var(--glow))}
@media(prefers-reduced-motion:reduce){.proto-3d *,.proto-3d .icon-core{animation:none!important}}
.protocol-option.selected .protocol-option-radio{border-color:#22d3ee;box-shadow:0 0 0 3px rgba(34,211,238,.10)}.protocol-option-icon{font-size:27px;line-height:1;margin-bottom:7px;filter:drop-shadow(0 5px 8px rgba(59,130,246,.24));position:relative;z-index:1}.protocol-option-name{font-size:11px;font-weight:900;position:relative;z-index:1}.protocol-option-desc{font-size:8.5px;color:var(--t3);margin-top:2px;position:relative;z-index:1}.protocol-picker-foot{padding:11px 16px 15px;border-top:1px solid rgba(148,163,184,.12);background:linear-gradient(180deg,transparent,rgba(255,255,255,.025));flex:0 0 auto}.protocol-selected-info{height:35px;border-radius:10px;border:1px solid rgba(59,130,246,.18);background:rgba(59,130,246,.07);display:flex;align-items:center;justify-content:center;color:#93c5fd;font-size:9px;margin-bottom:8px}.protocol-picker-confirm{width:100%;height:43px;border:0;border-radius:12px;background:linear-gradient(135deg,#2196f3,#6366f1 55%,#8b5cf6);color:#fff;font-family:inherit;font-size:12px;font-weight:900;cursor:pointer;box-shadow:0 8px 22px rgba(59,130,246,.28);transition:.18s}.protocol-picker-confirm:hover{filter:brightness(1.08);transform:translateY(-1px)}
...
const PROTOCOL_PICKER_ICONS={
  'vless-ws':'VL','xhttp-packet-up':'XP','xhttp-stream-up':'XS','xhttp-stream-one':'XC',
  'vmess-ws':'VN','trojan-ws':'TG','shadowsocks':'SM','socks5':'SG','http':'WS',
  'hysteria2':'HN','tuic':'TB','wireguard':'WO','highspeed-demo':'TS','gaming-lite-demo':'GP'
};
const PROTOCOL_PICKER_GROUPS=[
  {title:'VLESS • CORE',ids:['vless-ws','xhttp-packet-up','xhttp-stream-up','xhttp-stream-one']},
  {title:'VMess • NOVA',ids:['vmess-ws']},
  {title:'PROXY • MATRIX',ids:['trojan-ws','shadowsocks','socks5','http','hysteria2']},
  {title:'TUNNEL • ORBIT',ids:['tuic','wireguard']},
...
function protocolIconMarkup(id){
  ...
  return `<span class="protocol-option-icon proto-3d proto-${id} kind-${kind}" aria-hidden="true"><span class="icon-core"><span class="icon-orbit"></span><span class="icon-face"><span class="icon-glyph">${glyph}</span></span><span class="icon-spark"></span></span></span>`;
}
...
(function(){
  const ICON=PROTOCOL_PICKER_ICONS;
  const GROUPS=[
    ...
    ["LAB / TEST",["highspeed-demo","gaming-lite-demo"]]
  ];
  let target=null;
  const labels={'vless-ws':'Vortex Link','xhttp-packet-up':'XPacket Flow','xhttp-stream-up':'XStream Pulse','xhttp-stream-one':'XStream Core','vmess-ws':'VMesh Nova','trojan-ws':'Trojan Glide','shadowsocks':'Shadow Mesh','socks5':'Socket Guard','http':'Web Shield','hysteria2':'Hysteria Nova','tuic':'TUIC Blaze','wireguard':'WireGuard Orbit','highspeed-demo':'Turbo Surge','gaming-lite-demo':'Game Pulse'};
  function ensure(){
  ...
  function sync(id){
    ...
    const v=s.value||'vless-ws'; b.querySelector('.protocol-trigger-icon').innerHTML=protocolIconMarkup(v); b.querySelector('.protocol-trigger-name').textContent=labels[v]||v;
  }
  window.openProtocolPicker=function(id){
    ...
    GROUPS.forEach(([title,ids])=>{
      ...
      items.forEach(v=>{html+='<button type="button" class="protocol-option '+(v===current?'selected':'')+'" data-proto="'+v+'"><span class="protocol-option-radio"></span>'+protocolIconMarkup(v)+'<span class="protocol-option-name">'+(labels[v]||v)+'</span><span class="protocol-option-desc">'+(v===current?'انتخاب‌شده':'برای انتخاب کلیک کنید')+'</span></button>';});
      html+='</div></section>';
    });
