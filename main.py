...
def get_link_info(
    ...
    return {
        ...
        "all_protocols": bool(link.get("all_protocols", False)),
...
async def load_state():
    ...
    try:
        ...
        for uid, link in LINKS.items():
            ...
            link.setdefault("all_protocols", False)
...
<div class="form-row">
        ...
        <label class="all-protocol-toggle" for="cAllProtocols"><span><b>ساخت همه پروتکل‌ها باهم</b><small>یک اکانت با همه پروتکل‌های پنل و یک ساب</small></span><input id="cAllProtocols" type="checkbox"><i class="switch-ui"></i></label>
    ...
    <div class="card" style="border-color:rgba(139,92,246,.35)">
      ...
      <label class="all-protocol-toggle" for="aAllProtocols"><span><b>ساخت همه پروتکل‌ها باهم</b><small>یک اکانت با همه پروتکل‌های پنل و یک ساب</small></span><input id="aAllProtocols" type="checkbox"><i class="switch-ui"></i></label>
...
.all-protocol-toggle{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:10px 0 14px;padding:12px 14px;border:1px solid rgba(255,255,255,.08);border-radius:14px;background:rgba(255,255,255,.025);cursor:pointer;user-select:none}.all-protocol-toggle span{min-width:0}.all-protocol-toggle b{display:block;font-size:12px}.all-protocol-toggle small{display:block;color:var(--t3);font-size:11px;margin-top:3px}.all-protocol-toggle input{position:absolute;opacity:0;pointer-events:none}.switch-ui{position:relative;display:block;flex:0 0 auto;width:46px;height:26px;border-radius:999px;background:#3f3f46;transition:.2s;box-shadow:inset 0 0 0 1px rgba(255,255,255,.12)}.switch-ui:after{content:"";position:absolute;top:3px;left:3px;width:20px;height:20px;border-radius:50%;background:#fff;box-shadow:0 2px 6px rgba(0,0,0,.3);transition:.2s}.all-protocol-toggle input:checked + .switch-ui{background:#22c55e;box-shadow:inset 0 0 0 1px rgba(34,197,94,.45),0 0 0 2px rgba(34,197,94,.08)}.all-protocol-toggle input:checked + .switch-ui:after{transform:translateX(20px)}
</style>
