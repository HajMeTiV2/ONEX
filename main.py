...
\n<style id="proto3d-lego-final">\n.protocol-option-icon.proto3d-lego{width:82px!important;height:78px!important;display:grid!important;place-items:center!important;position:relative!important;flex:0 0 auto!important;perspective:180px!important}\n.proto3d-lego .lego-cube{position:relative;width:58px;height:46px;transform:rotateX(8deg) rotateY(-18deg) rotateZ(-1deg);transform-style:preserve-3d;filter:drop-shadow(0 13px 10px rgba(0,0,0,.34));transition:transform .22s ease,filter .22s ease}\n.proto3d-lego .lego-top,.proto3d-lego .lego-left,.proto3d-lego .lego-right,.proto3d-lego .lego-front{position:absolute;display:block;box-sizing:border-box}\n.proto3d-lego .lego-front{left:0;bottom:0;width:58px;height:39px;border-radius:7px 7px 9px 9px;background:linear-gradient(145deg,var(--lego-hi),var(--lego-main) 48%,var(--lego-dark));border:1px solid rgba(255,255,255,.25);display:grid;place-items:center;color:#fff;font-weight:1000;font-size:13px;letter-spacing:-.4px;text-shadow:0 2px 3px rgba(0,0,0,.42);box-shadow:inset 0 1px rgba(255,255,255,.38),inset 0 -7px 12px rgba(0,0,0,.13)}\n.proto3d-lego .lego-top{left:4px;top:0;width:58px;height:18px;transform:skewX(-28deg);transform-origin:left bottom;border-radius:6px 8px 3px 3px;background:linear-gradient(135deg,var(--lego-hi),var(--lego-main));border:1px solid rgba(255,255,255,.27);box-shadow:inset 0 1px rgba(255,255,255,.42)}\n.proto3d-lego .lego-left{left:-8px;bottom:2px;width:10px;height:37px;transform:skewY(-24deg);border-radius:5px 0 0 7px;background:linear-gradient(180deg,var(--lego-main),var(--lego-dark));opacity:.96}\n.proto3d-lego .lego-right{right:-9px;bottom:2px;width:11px;height:37px;transform:skewY(24deg);border-radius:0 5px 7px 0;background:linear-gradient(180deg,var(--lego-main),var(--lego-dark));opacity:.9}\n.proto3d-lego .lego-stud{position:absolute;top:-7px;width:15px;height:8px;border-radius:50%;background:radial-gradient(circle at 35% 30%,#fff7,transparent 25%),linear-gradient(145deg,var(--lego-hi),var(--lego-main) 65%,var(--lego-dark));border:1px solid rgba(255,255,255,.28);box-shadow:0 3px 5px rgba(0,0,0,.28),inset 0 1px rgba(255,255,255,.35)}\n.proto3d-lego .lego-stud.one{left:13px}.proto3d-lego .lego-stud.two{right:10px}\n.proto3d-lego .lego-shadow{position:absolute;bottom:2px;width:57px;height:10px;border-radius:50%;background:rgba(0,0,0,.35);filter:blur(6px);transform:translateY(7px)}\n.protocol-option:hover .proto3d-lego .lego-cube,.protocol-option.selected .proto3d-lego .lego-cube,.protocol-trigger:hover .proto3d-lego .lego-cube{transform:rotateX(8deg) rotateY(-18deg) rotateZ(-1deg) translateY(-4px) scale(1.07);filter:drop-shadow(0 16px 13px rgba(0,0,0,.4)) drop-shadow(0 0 10px var(--lego-glow))}\n.protocol-trigger-icon .proto3d-lego{width:43px!important;height:42px!important}.protocol-trigger-icon .proto3d-lego .lego-cube{width:34px;height:29px;transform:rotateX(8deg) rotateY(-18deg) scale(.68)}.protocol-trigger-icon .proto3d-lego .lego-front{width:40px;height:26px;font-size:9px;border-radius:4px}.protocol-trigger-icon .proto3d-lego .lego-top{width:40px;height:12px}.protocol-trigger-icon .proto3d-lego .lego-left,.protocol-trigger-icon .proto3d-lego .lego-right{height:25px;width:7px}.protocol-trigger-icon .proto3d-lego .lego-stud{width:9px;height:5px;top:-4px}.protocol-trigger-icon .proto3d-lego .lego-stud.one{left:9px}.protocol-trigger-icon .proto3d-lego .lego-stud.two{right:7px}\n.proto3d-vless-ws{--lego-main:#22c55e;--lego-hi:#86efac;--lego-dark:#047857;--lego-glow:rgba(34,197,94,.5)}\n.proto3d-xhttp-packet-up{--lego-main:#3b82f6;--lego-hi:#93c5fd;--lego-dark:#1d4ed8;--lego-glow:rgba(59,130,246,.5)}\n.proto3d-xhttp-stream-up{--lego-main:#8b5cf6;--lego-hi:#c4b5fd;--lego-dark:#6d28d9;--lego-glow:rgba(139,92,246,.5)}\n.proto3d-xhttp-stream-one{--lego-main:#06b6d4;--lego-hi:#67e8f9;--lego-dark:#0e7490;--lego-glow:rgba(6,182,212,.5)}\n.proto3d-vmess-ws{--lego-main:#a855f7;--lego-hi:#d8b4fe;--lego-dark:#7e22ce;--lego-glow:rgba(168,85,247,.5)}\n.proto3d-trojan-ws{--lego-main:#f43f5e;--lego-hi:#fda4af;--lego-dark:#be123c;--lego-glow:rgba(244,63,94,.5)}\n.proto3d-shadowsocks{--lego-main:#f59e0b;--lego-hi:#fde68a;--lego-dark:#b45309;--lego-glow:rgba(245,158,11,.5)}\n.proto3d-socks5{--lego-main:#14b8a6;--lego-hi:#99f6e4;--lego-dark:#0f766e;--lego-glow:rgba(20,184,166,.5)}\n.proto3d-http{--lego-main:#64748b;--lego-hi:#cbd5e1;--lego-dark:#334155;--lego-glow:rgba(148,163,184,.45)}\n.proto3d-hysteria2{--lego-main:#06b6d4;--lego-hi:#a5f3fc;--lego-dark:#155e75;--lego-glow:rgba(6,182,212,.5)}\n.proto3d-tuic{--lego-main:#f97316;--lego-hi:#fdba74;--lego-dark:#c2410c;--lego-glow:rgba(249,115,22,.5)}\n.proto3d-wireguard{--lego-main:#2563eb;--lego-hi:#93c5fd;--lego-dark:#1e40af;--lego-glow:rgba(37,99,235,.5)}\n.proto3d-highspeed-demo{--lego-main:#eab308;--lego-hi:#fef08a;--lego-dark:#a16207;--lego-glow:rgba(234,179,8,.5)}\n.proto3d-gaming-lite-demo{--lego-main:#d946ef;--lego-hi:#f0abfc;--lego-dark:#a21caf;--lego-glow:rgba(217,70,239,.5)}\n@media(max-width:560px){.protocol-option-icon.proto3d-lego{width:70px!important;height:66px!important}.proto3d-lego .lego-cube{transform:rotateX(8deg) rotateY(-18deg) scale(.9)}}\n</style>\n</head>
...
/* REAL 3D LEGO PROTOCOL ICONS - replaces the old PNG icons */
.protocol-option-icon.proto-3d{width:78px!important;height:78px!important;display:grid!important;place-items:center!important;position:relative!important;overflow:visible!important;filter:none!important}
.protocol-option-icon.proto-3d::before{content:"";position:absolute;width:48px;height:48px;border-radius:50%;filter:blur(13px);opacity:.32;transform:translateY(10px);pointer-events:none}
.lego-cube{position:relative;width:58px;height:52px;display:block;transform:rotate(-4deg) skewY(0deg);filter:drop-shadow(0 9px 7px rgba(0,0,0,.38));transition:transform .22s ease,filter .22s ease}
.lego-face{position:absolute;display:block}
.lego-top{left:10px;top:1px;width:38px;height:22px;transform:skewX(-32deg) rotate(0deg);border-radius:7px 6px 3px 3px;background:linear-gradient(135deg,#b78cff 0%,#7c3aed 58%,#5b21b6 100%);box-shadow:inset 2px 2px 3px rgba(255,255,255,.48),inset -3px -4px 5px rgba(0,0,0,.22)}
.lego-left{left:3px;top:16px;width:31px;height:34px;transform:skewY(31deg);border-radius:5px 3px 7px 8px;background:linear-gradient(145deg,#7c3aed 0%,#5b21b6 55%,#3b0764 100%);box-shadow:inset 2px 0 3px rgba(255,255,255,.25),inset -4px -3px 5px rgba(0,0,0,.25)}
.lego-right{right:2px;top:16px;width:31px;height:34px;transform:skewY(-31deg);border-radius:3px 6px 8px 5px;background:linear-gradient(145deg,#a855f7 0%,#7c3aed 45%,#4c1d95 100%);box-shadow:inset 0 2px 3px rgba(255,255,255,.34),inset -2px -3px 5px rgba(0,0,0,.28)}
.lego-stud{position:absolute;width:11px;height:7px;border-radius:50%;background:radial-gradient(circle at 35% 28%,rgba(255,255,255,.9) 0 13%,rgba(255,255,255,.35) 14% 30%,rgba(0,0,0,.25) 72%),linear-gradient(#d8b4ff,#7c3aed 65%,#4c1d95);box-shadow:0 2px 2px rgba(0,0,0,.28),inset 0 1px rgba(255,255,255,.35);z-index:5;transform:skewX(-32deg)}
.lego-stud.s1{left:13px;top:7px}.lego-stud.s2{left:28px;top:5px}.lego-stud.s3{left:20px;top:17px}.lego-stud.s4{left:35px;top:15px}
.lego-cube strong{position:absolute;z-index:8;left:0;right:0;top:22px;text-align:center;font:900 13px/1 Arial,sans-serif;color:#fff;text-shadow:0 2px 2px rgba(0,0,0,.55);letter-spacing:-.5px;transform:skewY(-2deg);pointer-events:none}
.protocol-option:hover .lego-cube,.protocol-option.selected .lego-cube,.protocol-trigger:hover .lego-cube{transform:translateY(-4px) rotate(-5deg) scale(1.07);filter:drop-shadow(0 13px 10px rgba(0,0,0,.45))}
/* color variants */
.lego-blue .lego-top{background:linear-gradient(135deg,#8bd5ff,#1683e8 60%,#0753a8)} .lego-blue .lego-left{background:linear-gradient(145deg,#1683e8,#0753a8 65%,#06356e)} .lego-blue .lego-right{background:linear-gradient(145deg,#46b8ff,#1671d9 55%,#084b9b)} .lego-blue .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#8bd5ff 15% 30%,#0753a8 72%),linear-gradient(#8bd5ff,#1683e8)}
.lego-cyan .lego-top{background:linear-gradient(135deg,#a5f3fc,#06b6d4 60%,#087a9b)} .lego-cyan .lego-left{background:linear-gradient(145deg,#06b6d4,#087a9b 65%,#064e62)} .lego-cyan .lego-right{background:linear-gradient(145deg,#67e8f9,#0891b2 55%,#075985)} .lego-cyan .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#a5f3fc 15% 30%,#087a9b 72%),linear-gradient(#a5f3fc,#06b6d4)}
.lego-purple .lego-top{background:linear-gradient(135deg,#e9d5ff,#9333ea 60%,#6b21a8)} .lego-purple .lego-left{background:linear-gradient(145deg,#9333ea,#6b21a8 65%,#3b0764)} .lego-purple .lego-right{background:linear-gradient(145deg,#c084fc,#9333ea 55%,#581c87)} .lego-purple .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#e9d5ff 15% 30%,#6b21a8 72%),linear-gradient(#e9d5ff,#9333ea)}
.lego-indigo .lego-top{background:linear-gradient(135deg,#c7d2fe,#6366f1 60%,#4338ca)} .lego-indigo .lego-left{background:linear-gradient(145deg,#6366f1,#4338ca 65%,#312e81)} .lego-indigo .lego-right{background:linear-gradient(145deg,#818cf8,#4f46e5 55%,#3730a3)} .lego-indigo .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#c7d2fe 15% 30%,#4338ca 72%),linear-gradient(#c7d2fe,#6366f1)}
.lego-red .lego-top{background:linear-gradient(135deg,#fecdd3,#ef4444 60%,#b91c1c)} .lego-red .lego-left{background:linear-gradient(145deg,#ef4444,#b91c1c 65%,#7f1d1d)} .lego-red .lego-right{background:linear-gradient(145deg,#fb7185,#dc2626 55%,#991b1b)} .lego-red .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#fecdd3 15% 30%,#b91c1c 72%),linear-gradient(#fecdd3,#ef4444)}
.lego-green .lego-top{background:linear-gradient(135deg,#bbf7d0,#22c55e 60%,#15803d)} .lego-green .lego-left{background:linear-gradient(145deg,#22c55e,#15803d 65%,#14532d)} .lego-green .lego-right{background:linear-gradient(145deg,#4ade80,#16a34a 55%,#166534)} .lego-green .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#bbf7d0 15% 30%,#15803d 72%),linear-gradient(#bbf7d0,#22c55e)}
.lego-sky .lego-top{background:linear-gradient(135deg,#bae6fd,#0ea5e9 60%,#0369a1)} .lego-sky .lego-left{background:linear-gradient(145deg,#0ea5e9,#0369a1 65%,#0c4a6e)} .lego-sky .lego-right{background:linear-gradient(145deg,#38bdf8,#0284c7 55%,#075985)} .lego-sky .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#bae6fd 15% 30%,#0369a1 72%),linear-gradient(#bae6fd,#0ea5e9)}
.lego-slate .lego-top{background:linear-gradient(135deg,#e2e8f0,#64748b 60%,#475569)} .lego-slate .lego-left{background:linear-gradient(145deg,#64748b,#475569 65%,#1e293b)} .lego-slate .lego-right{background:linear-gradient(145deg,#94a3b8,#64748b 55%,#334155)} .lego-slate .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#e2e8f0 15% 30%,#475569 72%),linear-gradient(#e2e8f0,#64748b)}
.lego-teal .lego-top{background:linear-gradient(135deg,#99f6e4,#14b8a6 60%,#0f766e)} .lego-teal .lego-left{background:linear-gradient(145deg,#14b8a6,#0f766e 65%,#134e4a)} .lego-teal .lego-right{background:linear-gradient(145deg,#2dd4bf,#0d9488 55%,#115e59)} .lego-teal .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#99f6e4 15% 30%,#0f766e 72%),linear-gradient(#99f6e4,#14b8a6)}
.lego-orange .lego-top{background:linear-gradient(135deg,#fed7aa,#f97316 60%,#c2410c)} .lego-orange .lego-left{background:linear-gradient(145deg,#f97316,#c2410c 65%,#7c2d12)} .lego-orange .lego-right{background:linear-gradient(145deg,#fb923c,#ea580c 55%,#9a3412)} .lego-orange .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#fed7aa 15% 30%,#c2410c 72%),linear-gradient(#fed7aa,#f97316)}
.lego-royal .lego-top{background:linear-gradient(135deg,#bfdbfe,#2563eb 60%,#1d4ed8)} .lego-royal .lego-left{background:linear-gradient(145deg,#2563eb,#1d4ed8 65%,#1e3a8a)} .lego-royal .lego-right{background:linear-gradient(145deg,#60a5fa,#2563eb 55%,#1e40af)} .lego-royal .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#bfdbfe 15% 30%,#1d4ed8 72%),linear-gradient(#bfdbfe,#2563eb)}
.lego-gold .lego-top{background:linear-gradient(135deg,#fef3c7,#f59e0b 60%,#b45309)} .lego-gold .lego-left{background:linear-gradient(145deg,#f59e0b,#b45309 65%,#78350f)} .lego-gold .lego-right{background:linear-gradient(145deg,#fbbf24,#d97706 55%,#92400e)} .lego-gold .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#fef3c7 15% 30%,#b45309 72%),linear-gradient(#fef3c7,#f59e0b)}
.lego-pink .lego-top{background:linear-gradient(135deg,#fbcfe8,#ec4899 60%,#be185d)} .lego-pink .lego-left{background:linear-gradient(145deg,#ec4899,#be185d 65%,#831843)} .lego-pink .lego-right{background:linear-gradient(145deg,#f472b6,#db2777 55%,#9d174d)} .lego-pink .lego-stud{background:radial-gradient(circle at 35% 28%,#fff 0 13%,#fbcfe8 15% 30%,#be185d 72%),linear-gradient(#fbcfe8,#ec4899)}
.protocol-option-icon.proto-3d.lego-violet::before{background:#8b5cf6}.protocol-option-icon.proto-3d.lego-blue::before{background:#2196f3}.protocol-option-icon.proto-3d.lego-cyan::before{background:#06b6d4}.protocol-option-icon.proto-3d.lego-purple::before{background:#a855f7}.protocol-option-icon.proto-3d.lego-indigo::before{background:#6366f1}.protocol-option-icon.proto-3d.lego-red::before{background:#ef4444}.protocol-option-icon.proto-3d.lego-green::before{background:#22c55e}.protocol-option-icon.proto-3d.lego-sky::before{background:#0ea5e9}.protocol-option-icon.proto-3d.lego-slate::before{background:#94a3b8}.protocol-option-icon.proto-3d.lego-teal::before{background:#14b8a6}.protocol-option-icon.proto-3d.lego-orange::before{background:#f97316}.protocol-option-icon.proto-3d.lego-royal::before{background:#2563eb}.protocol-option-icon.proto-3d.lego-gold::before{background:#f59e0b}.protocol-option-icon.proto-3d.lego-pink::before{background:#ec4899}
@media(max-width:560px){.protocol-option-icon.proto-3d{width:66px!important;height:66px!important}.lego-cube{transform:scale(.9) rotate(-4deg)}}
</style>
</head>
<body>
...
const PROTOCOL_3D_ICONS={"vless-ws": "data:image/png;base64,", "xhttp-packet-up": "data:image/png;base64,", "xhttp-stream-up": "data:image/png;base64,", "xhttp-stream-one": "data:image/png;base64,", "vmess-ws": "data:image/png;base64,", "trojan-ws": "data:image/png;base64,", "shadowsocks": "data:image/png;base64,", "socks5": "data:image/png;base64,", "http": "data:image/png;base64,", "hysteria2": "data:image/png;base64,", "tuic": "data:image/png;base64,", "wireguard": "data:image/png;base64,", "highspeed-demo": "data:image/png;base64,", "gaming-lite-demo": "data:image/png;base64,"};
...
function protocolIconMarkup(id){
 const meta={
  'vless-ws':['V','vless','violet'],'xhttp-packet-up':['XP','xpacket','blue'],'xhttp-stream-up':['XS','xstream','cyan'],'xhttp-stream-one':['XC','xcore','purple'],
  'vmess-ws':['M','vmess','indigo'],'trojan-ws':['T','trojan','red'],'shadowsocks':['S','shadow','green'],'socks5':['SO','socket','sky'],
  'http':['H','http','slate'],'hysteria2':['H2','hysteria','teal'],'tuic':['T','tuic','orange'],'wireguard':['W','wireguard','royal'],
  'highspeed-demo':['G','turbo','gold'],'gaming-lite-demo':['G','game','pink']
 }[id]||['?','proto','violet'];
 return `<span class="protocol-option-icon proto-3d lego-${meta[2]}" aria-hidden="true"><span class="lego-cube"><i class="lego-face lego-top"></i><i class="lego-face lego-left"></i><i class="lego-face lego-right"></i><b class="lego-stud s1"></b><b class="lego-stud s2"></b><b class="lego-stud s3"></b><b class="lego-stud s4"></b><strong>${meta[0]}</strong></span></span>`
}
