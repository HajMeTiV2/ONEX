...
/* ============================================================
   3D animated protocol icons — every protocol
   ============================================================ */
.protocol-option-icon.proto-3d{width:48px;height:48px;margin:0 0 6px;display:grid;place-items:center;position:relative;perspective:260px;z-index:2;filter:drop-shadow(0 9px 12px rgba(0,0,0,.30))}
.proto-3d .icon-core{position:relative;width:34px;height:34px;transform-style:preserve-3d;animation:protoFloat3d 3s ease-in-out infinite,protoSpin3d 7s linear infinite}
.proto-3d .icon-face{position:absolute;inset:2px;border-radius:10px;background:linear-gradient(145deg,var(--p1),var(--p2) 48%,var(--p3));box-shadow:inset 4px 4px 5px rgba(255,255,255,.32),inset -7px -8px 8px rgba(0,0,0,.28),0 10px 16px rgba(0,0,0,.25);transform:translateZ(5px) rotateX(16deg) rotateY(-12deg);display:grid;place-items:center;transform-style:preserve-3d;overflow:visible}
.proto-3d .icon-face:before{content:"";position:absolute;inset:-4px;border-radius:12px;border:1.5px solid rgba(255,255,255,.24);transform:translateZ(-7px) rotateX(62deg);animation:protoRing 2.8s linear infinite}
.proto-3d .icon-face:after{content:"";position:absolute;width:34px;height:8px;left:0;bottom:-8px;border-radius:50%;background:var(--glow);filter:blur(6px);transform:translateZ(-8px);opacity:.65}
.proto-3d .icon-glyph{font:900 9px/1 Arial,sans-serif;letter-spacing:-.4px;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.55);transform:translateZ(10px) rotateX(-4deg);user-select:none}
/* Individual 3D materials/colors */
.proto-vless-ws{--p1:#67e8f9;--p2:#2563eb;--p3:#312e81;--glow:rgba(34,211,238,.55)}
.proto-xhttp-packet-up{--p1:#a7f3d0;--p2:#059669;--p3:#064e3b;--glow:rgba(16,185,129,.55)}
.proto-xhttp-stream-up{--p1:#fde68a;--p2:#f59e0b;--p3:#92400e;--glow:rgba(245,158,11,.55)}
.proto-xhttp-stream-one{--p1:#c4b5fd;--p2:#7c3aed;--p3:#3b0764;--glow:rgba(139,92,246,.55)}
.proto-vmess-ws{--p1:#93c5fd;--p2:#4f46e5;--p3:#1e1b4b;--glow:rgba(99,102,241,.55)}
.proto-trojan-ws{--p1:#fda4af;--p2:#e11d48;--p3:#4c0519;--glow:rgba(244,63,94,.55)}
.proto-shadowsocks{--p1:#d9f99d;--p2:#65a30d;--p3:#365314;--glow:rgba(132,204,22,.55)}
.proto-socks5{--p1:#bae6fd;--p2:#0284c7;--p3:#082f49;--glow:rgba(14,165,233,.55)}
.proto-http{--p1:#e2e8f0;--p2:#64748b;--p3:#1e293b;--glow:rgba(148,163,184,.50)}
.proto-hysteria2{--p1:#a5f3fc;--p2:#0891b2;--p3:#164e63;--glow:rgba(6,182,212,.55)}
.proto-tuic{--p1:#fed7aa;--p2:#f97316;--p3:#7c2d12;--glow:rgba(249,115,22,.60)}
.proto-wireguard{--p1:#bfdbfe;--p2:#2563eb;--p3:#172554;--glow:rgba(37,99,235,.58)}
.proto-highspeed-demo{--p1:#fef08a;--p2:#eab308;--p3:#713f12;--glow:rgba(234,179,8,.60)}
.proto-gaming-lite-demo{--p1:#f5d0fe;--p2:#a855f7;--p3:#581c87;--glow:rgba(168,85,247,.60)}
@keyframes protoFloat3d{0%,100%{transform:translateY(0) rotateX(8deg) rotateY(-14deg)}50%{transform:translateY(-5px) rotateX(-6deg) rotateY(14deg)}}
@keyframes protoSpin3d{0%{rotate:0deg}50%{rotate:180deg}100%{rotate:360deg}}
@keyframes protoRing{to{transform:translateZ(-7px) rotateX(62deg) rotateZ(360deg)}}
.protocol-option:hover .proto-3d .icon-core{animation-duration:1.35s,.9s}
.protocol-option.selected .proto-3d{filter:drop-shadow(0 10px 18px rgba(56,189,248,.42))}
...
function protocolIconMarkup(id){
  ...
  return `<span class="protocol-option-icon proto-3d proto-${id}" aria-hidden="true"><span class="icon-core"><span class="icon-face"><span class="icon-glyph">${glyph}</span></span></span></span>`;
}
