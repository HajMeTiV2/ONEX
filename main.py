...
/* FINAL PROTOCOL UX: compact trigger + modal picker only.
   Protocol cards must NOT be rendered inline on the create page. */
#page-create .inline-protocol-picker{display:none!important;visibility:hidden!important;max-height:0!important;margin:0!important;padding:0!important;overflow:hidden!important}
#page-create .protocol-field > button.protocol-trigger{display:flex!important;visibility:visible!important;opacity:1!important;position:relative!important;z-index:30!important;width:100%!important;min-height:50px!important;align-items:center!important;justify-content:space-between!important}
#page-create .protocol-field > select.protocol-native{display:none!important}
@media(max-width:560px){#page-create .protocol-field > button.protocol-trigger{min-height:48px!important}}
</style>
</head>
<body>
