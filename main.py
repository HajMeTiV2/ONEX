...
function protocolIconMarkup(id){
  ...
  const kind={'vless-ws':'rocket','xhttp-packet-up':'packet','xhttp-stream-up':'pulse','xhttp-stream-one':'core','vmess-ws':'mesh','trojan-ws':'trojan','shadowsocks':'shadow','socks5':'socket','http':'shield','hysteria2':'vortex','tuic':'blaze','wireguard':'orbit','highspeed-demo':'turbo','gaming-lite-demo':'game'}[id]||'core';
...
(function(){
  ...
  const GROUPS=[
    ...
    ["NEON LAB",["highspeed-demo","gaming-lite-demo"]]
  ];
  let target=null;
