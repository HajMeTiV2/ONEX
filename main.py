...
#page-create .inline-protocol-picker{margin-top:8px;padding:12px;border-radius:20px;border:1px solid rgba(96,165,250,.18);background:linear-gradient(145deg,rgba(9,24,48,.72),rgba(3,10,23,.78));box-shadow:inset 0 1px rgba(255,255,255,.06),0 14px 34px rgba(0,0,0,.16);overflow:hidden}
#page-create .inline-protocol-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:0 2px 10px;direction:rtl}
#page-create .inline-protocol-title{font-size:12px;font-weight:900;color:var(--t1)}
#page-create .inline-protocol-subtitle{font-size:9px;color:var(--t3);margin-top:3px}
#page-create .inline-protocol-badge{min-width:30px;height:28px;padding:0 9px;border-radius:10px;display:grid;place-items:center;background:linear-gradient(135deg,#0ea5e9,#6366f1);color:#fff;font-size:10px;font-weight:900;box-shadow:0 7px 18px rgba(37,99,235,.24)}
#page-create .inline-protocol-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;direction:rtl}
#page-create .inline-protocol-card{position:relative;min-height:132px;border-radius:17px;border:1px solid rgba(96,165,250,.16);background:linear-gradient(145deg,rgba(17,35,66,.76),rgba(5,14,29,.86));padding:9px 7px 10px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:2px;color:var(--t1);cursor:pointer;overflow:hidden;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease,background .18s ease}
#page-create .inline-protocol-card:before{content:"";position:absolute;inset:-35% -20%;background:radial-gradient(circle at 50% 20%,rgba(56,189,248,.14),transparent 48%);pointer-events:none}
#page-create .inline-protocol-card:hover{transform:translateY(-3px);border-color:rgba(96,165,250,.48);box-shadow:0 14px 28px rgba(0,0,0,.22),0 0 22px rgba(37,99,235,.12)}
#page-create .inline-protocol-card.selected{transform:translateY(-2px);border-color:#38bdf8;background:linear-gradient(145deg,rgba(20,61,105,.9),rgba(25,18,70,.88));box-shadow:0 0 0 1px rgba(56,189,248,.18),0 12px 30px rgba(37,99,235,.18),inset 0 1px rgba(255,255,255,.08)}
#page-create .inline-protocol-card.selected:after{content:"✓";position:absolute;top:7px;right:7px;width:20px;height:20px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#38bdf8,#6366f1);color:#fff;font-size:11px;font-weight:900;box-shadow:0 4px 12px rgba(37,99,235,.3)}
#page-create .inline-protocol-radio{position:absolute;top:8px;left:8px;width:12px;height:12px;border-radius:50%;border:2px solid rgba(191,219,254,.55);z-index:2}
#page-create .inline-protocol-card.selected .inline-protocol-radio{border-color:#22d3ee;background:radial-gradient(circle,#22d3ee 0 42%,transparent 46%)}
#page-create .inline-protocol-card .protocol-option-icon.proto-3d{width:66px;height:66px;margin:0 0 3px;transition:transform .18s ease,filter .18s ease}
#page-create .inline-protocol-card:hover .protocol-option-icon.proto-3d{transform:translateY(-2px) scale(1.045)}
#page-create .inline-protocol-card .proto-3d .static-icon{width:64px;height:64px;filter:drop-shadow(0 9px 11px rgba(0,0,0,.34)) drop-shadow(0 0 8px rgba(56,189,248,.08))}
#page-create .inline-protocol-name{font-size:10.5px;font-weight:900;line-height:1.25;position:relative;z-index:2}
#page-create .inline-protocol-desc{font-size:7.5px;color:var(--t3);direction:ltr;position:relative;z-index:2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%}
html.light #page-create .inline-protocol-picker{background:linear-gradient(145deg,#fff,#f7fbff);border-color:rgba(15,23,42,.10);box-shadow:0 10px 28px rgba(15,23,42,.07),inset 0 1px rgba(255,255,255,.98)}
html.light #page-create .inline-protocol-card{background:linear-gradient(145deg,#fff,#f7faff);border-color:rgba(15,23,42,.10);color:#0f172a}
html.light #page-create .inline-protocol-card:hover{border-color:rgba(37,99,235,.35);box-shadow:0 12px 25px rgba(15,23,42,.09)}
html.light #page-create .inline-protocol-card.selected{border-color:#3b82f6;background:linear-gradient(145deg,#eff6ff,#f5f3ff);box-shadow:0 0 0 1px rgba(59,130,246,.14),0 10px 25px rgba(37,99,235,.10)}
@media(max-width:700px){#page-create .inline-protocol-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:420px){#page-create .inline-protocol-picker{padding:9px;border-radius:16px}#page-create .inline-protocol-grid{gap:7px}#page-create .inline-protocol-card{min-height:116px;border-radius:14px;padding:7px 5px}#page-create .inline-protocol-card .protocol-option-icon.proto-3d{width:58px;height:58px}#page-create .inline-protocol-card .proto-3d .static-icon{width:56px;height:56px}.inline-protocol-name{font-size:9.5px}.inline-protocol-desc{font-size:7px}}
...
function protocolIconMarkup(id){const src=PROTOCOL_3D_ICONS[id]||PROTOCOL_3D_ICONS['vless-ws'];return `<span class="protocol-option-icon proto-3d" aria-hidden="true"><img class="static-icon" src="${src}" alt=""></span>`}
function setupProtocolPickers(){['cProto','aProto'].forEach(id=>{const sel=document.getElementById(id);if(!sel)return;sel.classList.add('protocol-native');sel.style.setProperty('display','none','important');sel.setAttribute('aria-hidden','true');let trigger=sel.parentNode.querySelector(`.protocol-trigger[data-for="${id}"]`);if(!trigger){trigger=document.createElement('button');trigger.type='button';trigger.className='protocol-trigger';trigger.dataset.for=id;sel.parentNode.insertBefore(trigger,sel.nextSibling)}trigger.onclick=e=>{e.preventDefault();openProtocolPicker(id)};renderInlineProtocolPicker(id);syncProtocolPicker(id)})}
function renderInlineProtocolPicker(id){const sel=document.getElementById(id);if(!sel)return;const field=sel.closest('.protocol-field');if(!field)return;let wrap=field.querySelector('.inline-protocol-picker');if(!wrap){wrap=document.createElement('div');wrap.className='inline-protocol-picker';field.appendChild(wrap)}const options=[...sel.options];const current=sel.value||'vless-ws';wrap.innerHTML=`<div class="inline-protocol-head"><div><div class="inline-protocol-title">${lang==='fa'?'انتخاب پروتکل':'Choose Protocol'}</div><div class="inline-protocol-subtitle">${lang==='fa'?'پروتکل موردنظر را از کارت‌های سه‌بعدی انتخاب کنید':'Select a protocol from the 3D cards'}</div></div><span class="inline-protocol-badge">${options.length}</span></div><div class="inline-protocol-grid">${options.map(o=>{const pid=o.value;return `<button type="button" class="inline-protocol-card ${pid===current?'selected':''}" data-proto="${esc(pid)}" aria-pressed="${pid===current?'true':'false'}"><span class="inline-protocol-radio"></span>${protocolIconMarkup(pid)}<span class="inline-protocol-name">${esc(protocolPickerShort(pid))}</span><span class="inline-protocol-desc">${esc(pid)}</span></button>`}).join('')}</div>`;wrap.querySelectorAll('.inline-protocol-card').forEach(btn=>btn.addEventListener('click',()=>chooseInlineProtocol(id,btn.dataset.proto)))}
function chooseInlineProtocol(id,proto){const sel=document.getElementById(id);if(!sel)return;sel.value=proto;const wrap=sel.closest('.protocol-field')?.querySelector('.inline-protocol-picker');wrap?.querySelectorAll('.inline-protocol-card').forEach(x=>{const on=x.dataset.proto===proto;x.classList.toggle('selected',on);x.setAttribute('aria-pressed',on?'true':'false')});syncProtocolPicker(id);sel.dispatchEvent(new Event('change',{bubbles:true}))}
